...
Changes.read = function (pbf, end) {
    return pbf.readFields(Changes._readField, {type: 0, time: 0, position: null, rotation: null, lastShotTime: 0, hitBodyIds: [], missileHitBodyIds: []}, end);
};
Changes._readField = function (tag, obj, pbf) {
    ...
    else if (tag === 6) pbf.readPackedVarint(obj.missileHitBodyIds);
};
Changes.write = function (obj, pbf) {
    ...
    if (obj.missileHitBodyIds) pbf.writePackedVarint(6, obj.missileHitBodyIds);
};
